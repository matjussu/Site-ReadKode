  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Cards "Pourquoi ReadKode" — palette simplifiée (vert + orange)
        'card-icon-1': '#FF9500',    // Orange
        'card-icon-2': '#30D158',    // Vert
        'card-icon-3': '#FF9500',    // Orange
        'card-icon-4': '#30D158',    // Vert
        'card-icon-5': '#FF9500',    // Orange
        'card-title-1': '#FF9500',
        'card-title-2': '#30D158',
        'card-title-3': '#FF9500',
        'card-title-4': '#30D158',
        ...
        // Steps "Comment ça marche" — palette simplifiée
        'step-1': '#FF9500',         // Orange
        'step-2': '#30D158',         // Vert
        'step-3': '#FF9500',         // Orange
        'step-4': '#30D158',         // Vert
      ...
      boxShadow: {
        ...
        // Glow par card — alternance orange/vert
        'glow-card-1': '0 0 20px rgba(255, 149, 0, 0.4)',    // Orange
        'glow-card-2': '0 0 20px rgba(48, 209, 88, 0.4)',    // Vert
        'glow-card-3': '0 0 20px rgba(255, 149, 0, 0.4)',    // Orange
        'glow-card-4': '0 0 20px rgba(48, 209, 88, 0.4)',    // Vert
        'glow-card-5': '0 0 20px rgba(255, 149, 0, 0.4)',    // Orange
      },
      backgroundImage: {
